 ...
 */
contract PeakFinanceLotteryV2 is ReentrancyGuardUpgradeable, IPeakFinanceLottery, OwnableUpgradeable {
        ...
        nonReentrant
    {
        ...
        uint256 amountToShareToWinners = (
            ((_lotteries[_lotteryId].amountCollectedInPeak) * (10000 - _lotteries[_lotteryId].treasuryFee))
        ) / 10000;
        ...
        amountToWithdrawToTreasury += (_lotteries[_lotteryId].amountCollectedInPeak - amountToShareToWinners);
